...
![macOS](https://img.shields.io/badge/macOS-14%2B-blue?style=flat)
![Xcode](https://img.shields.io/badge/Xcode-16%2B-147EFB?style=flat)
![Swift](https://img.shields.io/badge/Swift-6.0%2B-orange?style=flat)
...
```text
dist/Audio.to.Text.using.ASR.LLM-v1.0.0-macOS.zip
```
